/*
 * @Author: zhaosj
 * @Date: 2022-01-15 09:07:24
 * @LastEditTime: 2022-01-15 09:42:29
 * @LastEditors: Please set LastEditors
 * @Description:
 * @FilePath: /protobuf_libevent/xclient_event.h
 */
#pragma once
#include <map>
...
class XClientEvent: public XMsgEvent
{
private:
    /* data */
public:
    ...
    //接收登录反馈消息
    void LoginRes(const char *pData, int nSize);

    typedef void (XClientEvent::*MsgCBFunc)(const char *pData, int nSize);
